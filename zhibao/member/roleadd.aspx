<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="roleadd.aspx.cs" Inherits="member_roleadd" %>
    ...
    <div class="page-content">
        ...
        <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="button" onclick="RoleAdd()"> <i class="icon-ok bigger-110"></i> 新增 </button>
                            &nbsp; &nbsp; &nbsp;
