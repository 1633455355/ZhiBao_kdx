<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="userbuildskinlist.aspx.cs" Inherits="member_userbuildskinlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="../js/userskinlist.js"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            $("#menuuser").addClass("active open");
            $("#menuuserbuildskinlist").addClass("active");
