<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="promotionupdate.aspx.cs" Inherits="member_promotionupdate" %>
...
<div class="breadcrumbs" id="breadcrumbs">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="clearfix form-actions" >
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="button" onclick="UpdatePromotion()"><i class="icon-ok bigger-110"></i>确定 </button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../js/promotionupdate.js"></script>
    <script type="text/javascript">
