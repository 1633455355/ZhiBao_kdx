<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="F_productimport.aspx.cs" Inherits="member_F_productimport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="col-xs-12">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group" id="divtypeone">
                        ...
                        <div class="col-sm-2">
                           <a class="btn btn-sm btn-danger" href="/Template/F_Template.xlsx">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#F_productimport").addClass("active");
