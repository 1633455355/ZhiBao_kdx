                ...
                <div class="form-horizontal">
                    ...
                    <asp:Panel ID="moreinfo" runat="server">
                        <div class="form-group" id="divname">
                            <label class="col-sm-3 control-label no-padding-right" for="name_txt">公司名称* </label>
                            <div class="col-sm-9">
                    ...
                    <asp:Panel ID="morestorefinfo" runat="server">
                        ...
                        <div class="form-group" id="divdealer">
                            <label class="col-sm-3 control-label no-padding-right" for="dealer_ddl">所属经销商 </label>
                            <div class="col-sm-2">
