<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="newsadd.aspx.cs" Inherits="member_newsadd" validaterequest="false" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="clearfix form-actions" >
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="button" onclick="checkadd()"> <i class="icon-ok bigger-110"></i> 确定 </button>
                            &nbsp; &nbsp; &nbsp;
