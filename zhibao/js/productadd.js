...
function ProductAdd()
{
    ...
    if(flag)
    {
        var params = { Action: "ProductAdd", TypeOne: encodeURIComponent(typeone), TypeTwo: encodeURIComponent(typetwo), Code: encodeURIComponent(code), Memo: encodeURIComponent(memo) };
        $.ajax({
            type: "POST",
            url: "../interface/Product.ashx",
            cache: false,
