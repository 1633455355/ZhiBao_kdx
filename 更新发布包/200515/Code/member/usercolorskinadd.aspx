            ...
            <div class="col-xs-12">
                ...
                <div class="form-horizontal">
                    <div class="form-group" id="divtfrontcode">
                        <label class="col-sm-3 control-label no-padding-right" for="frontcode_ddl">改色膜型号* </label>
                        <div class="col-sm-2">
                    ...
                    <div class="space-4"></div>
                     <div class="form-group" id="divtfrontProductcode">
                        <label class="col-sm-3 control-label no-padding-right" for="frontcode_ddl">改色膜卷轴号* </label>
                        <div class="col-sm-2">
